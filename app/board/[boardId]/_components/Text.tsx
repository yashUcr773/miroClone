...
export default function Text({ layer, onPointerDown, id, selectionColor }: TextProps) {
    ...
    return (
        <foreignObject x={x} y={y} width={width} height={height} onPointerDown={(e) => onPointerDown(e, id)}
            ...
            <ContentEditable html={value || "Text"} onChange={handleContentChange}
                ...
                style={{ fontSize: calculateFontSize(width, height), color: fill ? colorToCss(fill) : "#000" }}></ContentEditable>
        </foreignObject>
    );
};
